...
; Version 0.6 for Commander X16
; (c) 2019 Rebecca G Bettencourt, Kreative Software
; MIT License
...
VERACTL     EQU     $9F25 
; VIA register to set high memory bank.
RAMBANK     EQU     $9F61 
...
; Location in VRAM where the bitmap data starts; normally
; layer 0 (the text screen) ends at $7800 so we start at $8000.
VRAMBASE:   DW      $8000 
VRAMBANK:   DB      $00 
...
; Initialize VERA layer 1.
; Calculate VERA TILE_BASE from VRAMBASE.
U8MINIT:    LDA     VRAMBASE+0 
            STA     U8MINITTB+0 
            LDA     VRAMBASE+1 
            STA     U8MINITTB+1 
            LDA     VRAMBASE+2 
            ...
            ROR     U8MINITTB+1 
            ROR     U8MINITTB+0 
; Layer 1 registers, advance by 1.
            LDA     #$00 
            STA     VERAAL 
            LDA     #$30 
            STA     VERAAM 
            LDA     #$1F 
            STA     VERAAH 
; Set video mode to a bitmapped mode.
            LDA     BITDXEXP 
            EOR     #$07 
            ASL      
            ASL      
...
; TILEH = 0, TILEW = 1, MAPH = 0, MAPW = 0.
            ...
            LDA     #$10 
U8MINIT1:   STA     VERAD0 
; MAP_BASE = 0 (unused in bitmap modes).
            LDA     #$00 
            STA     VERAD0 
            STA     VERAD0 
; Set TILE_BASE.
...
; HSCROLL, VSCROLL = 0.
            ...
            STA     VERAD0 
            STA     VERAD0 
; Start at VRAMBASE, don't advance.
            LDA     VRAMBASE+0 
            STA     VERAAL 
            LDA     VRAMBASE+1 
            STA     VERAAM 
...
; Disable VERA layer 1.
; Layer 1 registers, advance by 0.
U8MEXIT:    LDA     #$00 
            STA     VERAAL 
            LDA     #$30 
            STA     VERAAM 
...
; Copy bits 0-1, 4-5 into bits 2-3, 6-7.
            ...
            ORA     CURCOLOR 
            STA     CURCOLOR 
; VERA does not support depths below 2bpp, so we're done.
; (Otherwise we would do one last ASL if bit depth was 1bpp.)
